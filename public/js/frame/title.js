...
define([
	...
	var Frame_Title_Model = Backbone.Model.extend({
	...
	var Frame_Title_View = Backbone.View.extend({

		el: '#frame_table_caption',
	...
	console.log("loaded frame/title.js");

	/* Expose public methods/properties */
	return {
		model: Frame_Title_Model,
		view: Frame_Title_View
	};
});
